...
using ExploreCalifornia.Integration;
using ExploreCalifornia.Persistence.Bookings;
using ExploreCalifornia.Persistence.Tours;
using ExploreCalifornia.Website.AutoMapperProfiles;
