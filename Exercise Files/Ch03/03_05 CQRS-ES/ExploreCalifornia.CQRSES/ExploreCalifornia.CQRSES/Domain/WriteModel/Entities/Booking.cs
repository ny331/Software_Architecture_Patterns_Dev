...
namespace ExploreCalifornia.CQRSES.Domain.WriteModel.Entities
{
    public class Booking : EventSourced
    {
        ...
        {
            Update(new TourBooked { TourId = tourId, Name = name, Email = email, Transport = transport });
        }
        ...
        {
            Update(new BookingCanceled { Email = Email, Name = Name, TourId = TourId, Reason = reason });
        }
